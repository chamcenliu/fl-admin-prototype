...
export const iterationVersions: IterationVersion[] = [
  {
    ...
    pageIds: ["admin-dashboard", "admin-users", "admin-resources", "admin-nodes", "admin-transactions", "admin-campaigns", "admin-auth-templates"],
  ...
  },
  {
    ...
    summary: "完成页面组织、版本水印、PRD 标注与示例业务页面。"
  },
  {
